...
final class Version20250702082457 extends AbstractMigration
{
    ...
    {
        //enum
        $this->addSql("CREATE TYPE coupon_discount_enum AS ENUM ('fixed', 'percent')");
        //main
        $this->addSql('CREATE TABLE coupon (id UUID NOT NULL, code VARCHAR(255) NOT NULL, discount_type coupon_discount_enum NOT NULL, value INT NOT NULL, PRIMARY KEY(id))');
